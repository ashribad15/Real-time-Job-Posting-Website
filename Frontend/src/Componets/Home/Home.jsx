    ...
    return (
        <>
            ...
            <div className="carousel">
                <div className="slide" style={{ transform: `translateX(-${currentSlide * 784}px)` }}>
                    <img src={first} alt="First slide" />
                    <img src={second} alt="Second slide" />
                    <img src={third} alt="Third slide" />
                    <img src={fourth} alt="Fourth slide" />
                </div>
                <button className="back" onClick={() => setCurrentSlide((prevSlide) => (prevSlide - 1 + 4) % 4)}>&lt;</button>
                <button className="next" onClick={() => setCurrentSlide((prevSlide) => (prevSlide + 1) % 4)}>&gt;</button>
            </div>
            ...
            <div className="logins flex h-32 mt-8">
                ...
                <div className="log flex">
                    ...
                    <a href="/register">
                        <button className='btn6'> Register Now </button>
                    </a>
                </div>
            </div>
        </>
