                    ...
                    <div className="elem">
                        <Link to={"/Internship"}>
                            <p id='int' className='' onMouseEnter={showInternships}>
                                Internships <i id='ico' className="bi bi-caret-down-fill" onClick={hideInternships}></i>
                            </p>
                        </Link>
                        <Link to={"/Jobs"}>
                            <p onMouseEnter={showJobs}>
                                Jobs <i className="bi bi-caret-down-fill" id='ico2' onClick={hideJobs}></i>
                            </p>
                        </Link>
                    </div>
                    ...
                    {user ? (
                        <>
                            <div className='Profile'>
                                <Link to={"/profile"}>
                                    <img src={user?.photo} alt="profile" onMouseEnter={showProfile} className='rounded-full w-12' id='picpro' />
                                    <i className='bi bi-caret-up-fill' id='ico3' onClick={hideProfile}></i>
                                </Link>
                            </div>
                        </>
                    ) : (
